...
(custom-set-variables
 ...
 '(package-selected-packages
   '(treemacs-magit treemacs company typescript-mode lsp-mode evil-nerd-commenter magit which-key smartparens rainbow-delimiters highlight-indent-guides powerline-evil helpful counsel ivy-rich ivy diminish editorconfig evil dracula-theme)))
(custom-set-faces
